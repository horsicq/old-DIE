...
begin
  MessageDlg('TAdvListView version ' + AdvListView1.GetVersionString + #13 + #10 + '© 1998-2006 by TMS software', mtInformation, [mbok], 0);
end;
...
begin
  ...
  begin
    ...
    begin
      ...
      SubItems.Add('D7 D2005 D2006');
      SubItems.Add('Feb 15, 2006');
